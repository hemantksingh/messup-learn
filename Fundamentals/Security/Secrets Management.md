...
* Delete a key
    * `gpg --delete-secret-key <your-email>`
    * `gpg --delete-key <your-email>`

* List keys
    * `gpg --list-secret-keys --keyid-format LONG`
    * `gpg --list-keys`

* Export a key `gpg --armor --export <your-email> > public-key.gpg`

* Import a key `gpg --import public-key.gpg`
...
* Add a blackbox admin `blackbox_addadmin <gpg-uid>`
...
* Add them as admin `blackbox_addadmin <gpg-uid>`
* Import their public key `gpg --import public-key.gpg`
