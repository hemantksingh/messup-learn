...
2. Domain model's persistence and messaging persistence store are controlled under a global XA transaction (two-phase commit). The coordinator becomes a lock held across the network. Pat Helland in his paper [Life beyond Distributed Transactions](http://www-db.cs.wisc.edu/cidr/cidr2007/papers/cidr07p15.pdf) says *"Attempts to use distributed transactions are too fragile and perform poorly"*.
...
* Pat Helland, [Life beyond Distributed Transactions](http://www-db.cs.wisc.edu/cidr/cidr2007/papers/cidr07p15.pdf), CIDR 2007
